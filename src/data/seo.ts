...
const seoSource: Record<RouteKey, SeoData> = {
  ...
  concert: {
    title: 'Eternas Canções ao vivo no Rio | Max Wilson Pereira',
    description: 'Eternas Canções, com Max Wilson Pereira, em 21 de dezembro de 2026, às 20h, no Teatro Vannucci, Rio de Janeiro. Garanta seu ingresso na Sympla.',
    ogDescription: 'Uma única apresentação de Eternas Canções no Teatro Vannucci, Rio de Janeiro, em 21 de dezembro de 2026, às 20h.',
    image: '/assets/optimized/eternas-cancoes-1128.webp',
    imageAlt: 'Cartaz do concerto Eternas Canções com Max Wilson Pereira e convidados',
    imageWidth: 1128,
    imageHeight: 634,
...
export function getSeo(route: RouteKey, locale: Locale): SeoData {
  ...
  return {
    ...
    imageAlt: t(locale, source.imageAlt ?? 'Max Wilson Pereira em apresentação ao vivo com Hebe Camargo'),
